...
<head>
    ...
    <title>hello</title>
    <link href="<c:url value="/css/style-order.css" />" rel="stylesheet">
...
<c:set var="currentPage" value="${orderDetailsPage.number}" />
<c:set var="numberOfPages" value="${orderDetailsPage.totalPages}" />
<c:set var="orderDetails" value="${orderDetailsPage.content}" />
<body>
<header class="d-flex">
...
<script src="<c:url value="/js/script-cart.js"/>"></script>
</body>