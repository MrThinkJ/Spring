                ...
                <div class="wrapper-margin-product">
                    <div class="wrapper-padding-product">
                        <div class="wrapper-product">
                            <div class="product">
                                <div class="product-image" style="background-image: url(<c:url value="/resources/image/product/product1.jfif"/>);">
                                </div>
                            ...
                            <div class="quantity">
                                <form action="decrease" method="post" class="d-flex">
                                ...
                                <form action="increase" method="post" class="d-flex">
                                    <input name="product-id" type="text" value="${orderDetail.getProduct().getId()}"
                                           style="display: none;">
                            ...
                            <form action="remove" method="post" class="d-flex">
                                <input name="product-id" type="text" value="${orderDetail.getProduct().getId()}"
                                       style="display: none;">
